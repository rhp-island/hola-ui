...
const Stories = defineComponent({
  ...
  setup(props) {
    return () => {
      const holaLogo = h(
        ...
        () =>
          h(hola.img, {
            ...
            mt: 4,
            src:
              'https://res.cloudinary.com/xtellar/image/upload/v1584242872/hola-ui/hola-ui-vue.png',
          })
      )

      const storyTitle = (story) =>
        h(hola.h3, { mt: 2, mb: 0, fontWeight: 'bold' }, () => story.name)
      ...
      return h(hola.nav, { overflowY: 'scroll', w: '250px' }, () =>
        h(
          hola.ul,
          {
            p: 0,
