...
export const ring: Config = {
  ...
  ringColor: t.colors('--hola-ring-color'),
  ringOffset: t.prop('--hola-ring-offset-width'),
  ringOffsetColor: t.colors('--hola-ring-offset-color'),
  ringInset: t.prop('--hola-ring-inset'),
}
