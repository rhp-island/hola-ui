import { Dict, isObject, mergeWith } from '@hola-ui/utils'
 ...
 *
 * @example
 * tokenToCssVar('colors.red.500', 'hola')
 * => {
 *   variable: '--hola-colors-red-500',
 *   reference: 'var(--hola-colors-red-500)'
 * }
 */
    ...
    cssVars = mergeWith(
      ...
      Object.entries(normalizedValue).reduce(
        (acc, [conditionAlias, conditionValue]) => {
          ...
          /** @example { _dark: "#fff" } => { '.hola-ui-dark': "#fff" } */
