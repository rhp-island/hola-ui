import type { ThemingProps } from '@hola-ui/system'
import type { Breakpoints, Styles } from '@hola-ui/theme-tools'
import type { Dict } from '@hola-ui/utils'
import type { StyleObjectOrFn, SystemStyleObject } from '@hola-ui/styled-system'
...
export interface HolaTheme extends Foundations {
