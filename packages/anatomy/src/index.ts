import { anatomy } from '@hola-ui/theme-tools'

/**
 * Hey! Welcome to @hola-ui/vue-next Anatomy
 *
 * The anatomy of all hola components
 *
 * @see Docs     https://vue.hola-ui.com/anatomy
 * @see Source   https://github.com/rhp-island/hola-ui/blob/master/packages/vue-anatomy/src/vue-anatomy/vue-anatomy.ts
