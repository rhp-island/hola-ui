...
export type HolaFactoryElements = 'input' | 'select' | 'textarea'

interface HolaFactoryElementHandlers {
  onChange?: Function[]
  onInput?: Function[]
}
...
const events = new Map<
  ...
  HolaFactoryElementHandlers
>()

export function useFormElement(element: HolaFactoryElements, props: any) {
