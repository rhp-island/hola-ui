...
export interface HolaProps extends SystemProps, StyleResolverProps {
  /**
  ...
  /**
   * Internal prop used to label Hola factory component tags
   */
  label?: string
  /**
...
export type HTMLHolaProps<T extends As> = Omit<
  PropsOf<T>,
  T extends 'svg'
